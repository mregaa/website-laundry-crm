...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold">Tambah Reward Baru</h1>
        </div>
        ...
        <form action="{{ route('rewards.store') }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="space-y-4">
                    <div>
                        <label class="block text-gray-700 mb-2">Nama Reward *</label>
                        <input type="text" name="name" value="{{ old('name') }}" 
                               class="w-full border rounded px-3 py-2" 
                               placeholder="contoh, Diskon 5%" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="discount_amount" step="0.01" min="0" 
                                   ...
                                   class="w-full border rounded px-3 py-2" 
                                   placeholder="0.00">
                            <small class="text-gray-500">Diskon harga tetap</small>
                        </div>
                        <div>
                            ...
                            <input type="number" name="discount_percentage" min="0" max="100" 
                                   ...
                                   class="w-full border rounded px-3 py-2" 
                                   placeholder="0">
                            <small class="text-gray-500">Persentase diskon</small>
                        </div>
                    </div>

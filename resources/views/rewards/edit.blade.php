...
@section('title', 'Ubah Reward')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold">Ubah Reward</h1>
        </div>
        ...
        <form action="{{ route('rewards.update', $reward) }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" class="w-full border rounded px-3 py-2" rows="3" required>{{ old('description', $reward->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" 
                                   {{ old('is_active', $reward->is_active) ? 'checked' : '' }} class="mr-2">
            ...
            <div class="mt-6 flex justify-end space-x-2">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded">
                    <i class="fas fa-save"></i> Perbarui Reward
                </button>
            </div>
        </form>
    </div>
